...
# df1 contenant les candidats qui n'avaient pas de schema
df1 = df.select([col(c).alias(mapping.get(c, c)) for c in df.columns[28:105]])
...
df_final.write.option("header",True) \
    ...
    .csv("/data/tour1_par_departement")